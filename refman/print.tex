\chapter{Print rules}\label{print}

Print rules define how abstract syntax trees are converted
into strings. They are implicitly used by the \ident{gentext}
...
texts starts with the top-level node passed to \ident{gentext}.
...
\begin{grammar}
   ...
   \nonterminal{print-rule}
	 ...
	 \lextoken{->} \nonterminal{print-expression} \lextoken{;}
\end{grammar}
